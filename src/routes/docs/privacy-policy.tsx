      ...
      <Container>
        <section className='wrapper-container'>
          ...
          <ul>
            ...
            <li>
              <strong>Application</strong> refers to Choconotey, the software program
          ...
          <p>
            No data will still be available or hold in our servers once deleted by you in
            all cases.
          </p>
          <p>
