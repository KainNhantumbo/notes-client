...
export function selectStyles(theme: DefaultTheme): StylesConfig {
  return {
    ...
    control: (baseStyles) => ({
      ...
      color: `rgb(${theme.font})`,
      ':focus': {
        border: ` 1px solid rgba(${theme.black}, 0.15);`,
        boxShadow: `0 0 20px rgba(${theme.black}, 0.05);`,
      },
      ':hover': {
        border: ` 1px solid rgba(${theme.black}, 0.15);`,
      ...
      ':read-only': {
        border: ` 1px solid rgba(${theme.black}, 0.05);`,
        boxShadow: `0 0 20px rgba(${theme.black}, 0.02);`,
        color: `rgb(${theme.font})`,
      },
    }),
    input: (baseStyles) => ({
    ...
    container: (baseStyles) => ({
      ...
      ':focus': {
        ...
        boxShadow: `0 0 25px rgba(${theme.black}, 0.06);`,
      },
    }),
